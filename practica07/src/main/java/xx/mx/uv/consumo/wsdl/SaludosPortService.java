 ...
 * 
 */
@WebServiceClient(name = "saludosPortService", targetNamespace = "t4is.uv.mx/saludos", wsdlLocation = "file:/app/src/main/resources/saludos.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/app/src/main/resources/saludos.wsdl");
